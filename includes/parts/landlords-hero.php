<section id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active">
            ...
            <img src="img/hero/landlords.jpg" class="d-block carousel-bg-img" alt="...">
            <div class="carousel-caption d-md-block">
                            <p class="lead pt-2">Landlord Certificates</p>
                <ul class="carousel-list mt-4">
                    <li class="carousel-list-item font-weight-bold">Gas Certificates</li>
                    <li class="carousel-list-item font-weight-bold">Gas & Electrical Inspections</li>
