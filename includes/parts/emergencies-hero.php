<section id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner">
        ...
        <img src="img/hero/waterleak.jpg" class="d-block carousel-bg-img" alt="...">
        <div class="carousel-caption d-md-block">
                            <p class="lead pt-2">Emergency Service</p>
            <ul class="carousel-list mt-4">
                <li class="carousel-list-item font-weight-bold">24 Hour Emergency Callout</li>
